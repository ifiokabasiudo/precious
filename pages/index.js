    ...
    return(
        <div>
            <Head>
                ...
                <link href="../public/icon.png" rel="icon"/>
                        ...
                        <div className="carousel-inner">
                                ...
                                <div className="carousel-1">
                                    <div className="video-container">
                                        <div className="video">
                                            ...
                                            <video className="vid" src={(require('../public/vid-1.mp4'))} controls></video>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="carousel-item">
                                <div className="carousel-1">
                                    <div className="video">
                                        <h3 className="visits">Visits</h3>
                                        <video className="vid" src={(require('../public/vid-2.mp4'))} controls></video>
                                    </div>
                                </div>                            
                                <div className="carousel-caption d-none d-md-block text">
                            ...
                            <div className="carousel-item">
                                <div className="carousel-1">
                                    <div className="video">
                                        <h3 className="visits">Visits</h3>
                                        <video className="vid" src={(require('../public/vid-3.mp4'))} controls></video>
                                    </div>
                                </div>
                                <div className="carousel-caption d-none d-md-block text">
                            ...
                            <div className="carousel-item">
                                <div className="carousel-1">
                                    <div className="video">
                                        <h3 className="visits">Visits</h3>
                                        <video className="vid" src={(require('../public/vid-4.mp4'))} controls></video>
                                    </div>
                                </div>
                                <div className="carousel-caption d-none d-md-block text">
                            ...
                            <div className="carousel-item">
                                <div className="carousel-1">
                                    <div className="video">
                                        <h3 className="visits">Visits</h3>
                                        <video className="vid" src={(require('../public/vid-5.mp4'))} controls></video>
                                    </div>
                                </div>
                                <div className="carousel-caption d-none d-md-block text">
                            ...
                            <div className="carousel-item">
                                <div className="carousel-1">
                                    <div className="video">
                                        <h3 className="visits">Visits</h3>
                                        <video className="vid" src={(require('../public/vid-6.mp4'))} controls></video>
                                    </div>
                                </div>
                                <div className="carousel-caption d-none d-md-block text">
